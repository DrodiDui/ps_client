...
import TaskStatusChangeDialogComponent from "@/components/custom/tasks/TaskStatusChangeDialog";
...
const TaskDetailsDialog = ({task, open, onOpenChange}: TaskDetailsDialogProps) => {
    ...
    const handleStatusChangeSuccess = (updatedTask: TaskResponse) => {
    ...
    return (
        <>
            ...
            <TaskStatusChangeDialogComponent
                task={currentTask}
